...
export function ShowingFeedbackView({
  ...
  const primaryBtn = 'w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-black py-4 rounded-xl transition shadow'
        ...
        <div className="p-6">
          {step === 'home' && (
            <div className="animate-fade-in-up">
              ...
              <div className="text-center mb-8">
                <span className="text-xs font-bold tracking-widest text-amber-500 uppercase block mb-2 font-seller">Seller Tools</span>
              ...
              <div className="space-y-4">
                ...
                <ToolTile
                  ...
                  className="group relative bg-white hover:bg-amber-50 text-slate-900 p-6 rounded-3xl shadow-xl flex flex-col justify-between min-h-[120px] overflow-hidden border-2 border-transparent hover:border-amber-300"
                >
                ...
                {campaigns.length === 0 ? (
                  ...
                  campaigns.map(c => (
                    ...
                    >
                      ...
                      <div className="text-xs font-bold px-2 py-1 rounded bg-slate-700 text-amber-300">
                ...
                {listings.length === 0 ? (
                  ...
                  listings.map(listing => (
                    <div
                      ...
                      className="bg-slate-800 border border-slate-700 rounded-xl p-4 flex justify-between items-center cursor-pointer hover:border-amber-500/50 transition"
                    >
                      <div>
          ...
          {step === 'template' && (
            <div className="animate-fade-in-up">
              ...
              {selectedListing && (
                <p className="text-sm text-amber-300 font-bold mb-6">{selectedListing.address}</p>
              )}
              <div className="space-y-4">
                <div
                  className="bg-amber-500/10 border-2 border-dashed border-amber-500/50 rounded-xl p-5 hover:bg-amber-500/20 hover:border-amber-500 transition cursor-pointer flex flex-col items-center justify-center text-center mb-6 min-h-[140px]"
                  onClick={() => {
                ...
                >
                  <div className="w-10 h-10 bg-amber-500 text-slate-950 rounded-full flex items-center justify-center mb-2 shadow-lg">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M12 4v16m8-8H4"></path></svg>
                  </div>
                  <h3 className="text-lg font-bold text-amber-400">Build from Scratch</h3>
                  <p className="text-sm text-amber-300/70">Create a completely custom questionnaire</p>
                </div>
                ...
                {SHOWING_FEEDBACK_TEMPLATES.map((tpl, i) => (
                  <div key={i} className="bg-slate-800 border border-slate-700 rounded-xl p-5 hover:border-amber-500 transition cursor-pointer" onClick={() => handleCreate(tpl)}>
              ...
              <div className="space-y-4 mb-8">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-amber-500 font-bold"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-slate-300 text-sm focus:outline-none focus:border-amber-500 resize-none"
                  ></textarea>
                </div>
              </div>
          ...
          {step === 'detail' && activeCampaign && (
            <div className="animate-fade-in-up pb-8">
              <div className="mb-8">
                <h2 className="font-seller text-3xl md:text-5xl text-amber-400 leading-tight">
              ...
              <div className="bg-slate-800 rounded-xl p-5 mb-6 flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-amber-500 text-slate-950 rounded-full flex items-center justify-center mb-3 shadow-lg text-2xl font-black">
                ...
                <button
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-black py-4 rounded-xl transition shadow"
                >
                  See Responses
                </button>
              </div>
          ...
          {step === 'responses' && activeCampaign && (
            <div className="animate-fade-in-up pb-8">
              ...
              <div className="w-16 h-16 bg-amber-500 text-slate-950 rounded-full flex items-center justify-center mb-6 shadow-lg text-2xl font-black mx-auto">
                {activeCampaign.responses?.length || 0}
              </div>
                      ...
                      <div className="space-y-3">
                        {activeCampaign.questions.map((q) => (
                          <div key={q.id}>
                            ...
                            <p className="text-sm text-amber-300 bg-slate-900 p-2 rounded">{String((resp as { answers?: Record<string, string> }).answers?.[q.id] || 'No answer')}</p>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <div className="flex-none p-6 bg-slate-900 border-t border-slate-800 z-10 pb-safe">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black py-4 rounded-xl transition shadow text-base"
            >
              Copy Seller Link
            </button>
          </div>
