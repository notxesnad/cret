  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className={`${pickerInputClass} border ${className} ${value ? 'text-white' : 'text-transparent'}`}
      />
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        onClick={e => openPicker(e.currentTarget)}
        className={`${pickerInputClass} border rounded-xl font-bold ${className} ${value ? 'text-white' : 'text-transparent'}`}
      />
      <svg className="pointer-events-none absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
