  ...
  return (
    <div id="view-seller" className="app-view active space-y-4">
      ...
      >
        ...
        <span className="text-xs font-bold tracking-wider uppercase opacity-70">Customizable</span>
        <h2 className="font-seller text-2xl md:text-3xl mt-1 font-black">Detailed Net Sheet</h2>
      </div>
