...
export default async function ShowingFeedbackReportPage({
  params,
  searchParams,
}: {
  ...
  await trackShareVisit({
    ...
    profileId,
    sourceId: campaignId,
    path: `/showing-feedback/${profileId}/${campaignId}/report`,
    searchParams,
  })

  return <OpenHouseFeedbackReportView profile={profile} campaign={campaign} variant="showing" />
}
